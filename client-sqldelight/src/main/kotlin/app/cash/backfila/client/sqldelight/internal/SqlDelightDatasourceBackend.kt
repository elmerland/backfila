...
class SqlDelightDatasourceBackend @Inject constructor(
  ...
  private fun <T: Transacter, R : Any, Param : Any> createSqlDelightDatasourceOperator(
    backfill: SqlDelightDatasourceBackfill<T, R, Param>,
  ...
  private fun <T: Transacter, R : Any, P : Any> parametersClass(backfillClass: KClass<out SqlDelightDatasourceBackfill<T, R, P>>): KClass<P> {
    // Like MyBackfill.
