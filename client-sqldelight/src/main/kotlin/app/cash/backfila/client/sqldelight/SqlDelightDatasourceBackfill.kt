...
abstract class SqlDelightDatasourceBackfill<D : Transacter, R : Any, P : Any, K : Any>(
  val transacter: D
): Backfill {
  ...
  /* TODO: temp added for now */
  abstract fun computeOverallMinMax(requestRange: KeyRange): Pair<K?,K?>
}
